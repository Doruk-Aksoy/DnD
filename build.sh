...
7z u -t7z dnd$version.pk7 ./dnd/* -mx=9
7z d dnd$version.pk7 TEXTURES -x!TEXTURES/
7z rn dnd$version.pk7 TEXTURES_ TEXTURES
7z u -t7z dnd_monsters$version.pk7 ./monsters/* -mx=9
7z u -t7z dnd_onlyammo$version.pk7 ./onlyammo/* -mx=9
