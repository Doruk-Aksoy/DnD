...
enum {
	HELMWEIGHT_LICH = 10,
	HELMWEIGHT_WARRIOR = 22,
	HELMWEIGHT_SYNTH = 46,
	HELMWEIGHT_KNIGHT = 58,
	HELMWEIGHT_PREDATOR = 66,
	HELMWEIGHT_CRUSADER = 74,
	HELMWEIGHT_TACTICAL = 88,
	HELMWEIGHT_ROBE = 99,
	HELMWEIGHT_ELDER = 100
};
...
void SetupArmorDropWeights() {
	...
	ArmorDropWeights[DND_DROPPEDARMOR_HELM][HELMS_ELDER] = HELMWEIGHT_ELDER;
}
