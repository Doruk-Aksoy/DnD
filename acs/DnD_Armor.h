...
void SetupArmorDropWeights() {
	...
	// Helms
	RESET_ITEM_WEIGHTS;
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_LICH, 10);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_WARRIOR, 12);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_SYNTHMETAL, 24);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_KNIGHT, 12);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_PREDATOR, 8);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_CRUSADER, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_TACTICAL, 14);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_ROBE, 10);
