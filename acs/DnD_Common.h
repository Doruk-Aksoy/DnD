...
enum {
	...
	// the spawned pustules, NOT their map spots -- sharing a spot tid would keep ThingCount
	// counting the spot itself, so a popped pustule would never read as gone
	DND_ULTIMATUM_PUSTULE_TID,
	DND_ULTIMATUM_PUSTULE_TID_END = DND_ULTIMATUM_PUSTULE_TID + 32,
