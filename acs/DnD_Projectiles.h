...
enum {
	...
	DND_HITSCAN_RIOTGUN,
	DND_HITSCAN_RIOTGUN_NITRO,
	DND_HITSCAN_RIOTGUN_EXPSHELL,
...
#define MAX_HITSCAN_IDS (DND_HITSCAN_LAST + 1)

global int 32: HitscanDamageData[MAX_HITSCAN_IDS];
...
void SetupHitscanData() {
	...
	HitscanDamageData[DND_HITSCAN_RIOTGUN_NITRO] = 
		DND_WEAPON_RIOTCANNON |
		(DND_DMGID_1 << CACHE_SHIFT) |
		(DND_DAMAGETYPE_ICE << DTYPE_SHIFT) |
		(100 << DPCT_SHIFT);

	HitscanDamageData[DND_HITSCAN_RIOTGUN_EXPSHELL] = 
		DND_WEAPON_RIOTCANNON |
		(DND_DMGID_1 << CACHE_SHIFT) |
		(DND_DAMAGETYPE_PHYSICAL << DTYPE_SHIFT) |
		(100 << DPCT_SHIFT);
