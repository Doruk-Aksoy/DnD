...
#define LESHRAC_T 16
#define LESHRAC_RANDOM_ANG 0.03
#define LESHRAC_DIST_VAR_FACTOR 8
#define LESHRAC_DIST_VAR 28
#define LESHRAC_DIST_VAR_HALF (LESHRAC_DIST_VAR * LESHRAC_DIST_VAR_FACTOR) / 2
#define LESHRAC_MIN_DIST 72
...
#define THORAX_PROJ_SPEEDLIM (40 * 8)

#define ERYXIA_T 24
#define ERYXIA_RANDOM_ANG 0.04
#define ERYXIA_SALVO 6
#define ERYXIA_MIN_DIST 160
#define ERYXIA_SALVO_DELAY 3
#define ERYXIA_PROJ_SPEEDLIM (30 * 8)

#define ZRAVOG_SLAM_FXCOUNT 32
#define ZRAVOG_SLAM_RADIUS 192
#define ZRAVOG_SLAM_SHAKE 11
#define ZRAVOG_SLAM_RELIEF 9

#define ABAXOTH_THUNDER_TIME 87
#define ABAXOTH_THUNDER_HEALFREQ 12
#define ABAXOTH_THUNDER_HEALCOUNT (ABAXOTH_THUNDER_TIME / ABAXOTH_THUNDER_HEALFREQ)
#define ABAXOTH_THUNDER_HEAL 100
#define ABAXOTH_THUNDER_Y 800.0
#define ABAXOTH_THUNDER_Y2 600.0
#define ABAXOTH_SHIELD_DURATION (7 * TICRATE) // 7 secs
#define ABAXOTH_THUNDER_HEALPERCENT 10 // 10%

#define SHAMBLER_ATTACK_POINTS_MORE 32
#define SHAMBLER_ATTACK_POINTS 16
#define SHAMBLER_ATTACK_POINTS_FEW 8
#define SHAMBLER_LGSWAY 160
#define SHAMBLER_LGSWAYF 160.0
#define SHAMBLER_LGJAGG (1.0 / SHAMBLER_LGSWAY)
#define SHAMBLER_LGDENSITY 2
#define SHAMBLER_LGDISTY 32
#define SHAMBLER_TZ 32.0
#define SHAMBLER_LGDISTX 64
#define SHAMBLER_ZCHANGE 16384.0

#define SHAMBLER_LGDISTX_FORM1 -5
#define SHAMBLER_LGDISTY_FORM1 26
#define SHAMBLER_LGDISTY_FORM1D 15
#define SHAMBLER_LGDISTZ_FORM1 105.0
#define SHAMBLER_LGDISTZ_FORM1D 99.0

#define SHAMBLER_LGDISTX_FORM2 2
#define SHAMBLER_LGDISTY_FORM2 14
#define SHAMBLER_LGDISTY_FORM2D 18
#define SHAMBLER_LGDISTZ_FORM2 116.0
#define SHAMBLER_LGDISTZ_FORM2D 107.0

#define SHAMBLER_LGDISTX_FORM3 -2
#define SHAMBLER_LGDISTX_FORM3D SHAMBLER_LGDISTX
#define SHAMBLER_LGDISTY_FORM3 44
#define SHAMBLER_LGDISTY_FORM3D 0
#define SHAMBLER_LGDISTZ_FORM3 53.0

#define SHAMBLER_LGDISTX_FORM4 -5
#define SHAMBLER_LGDISTY_FORM4 -70
#define SHAMBLER_LGDISTZ_FORM4 50.0
#define SHAMBLER_LGDISTZ_FORM4D 53.0

// used for shambler hands
typedef struct {
	// lg dist of source
	int sx;
	int sy;
