...
enum {
    ...
    DND_MAPEVENT_NOPAIN,
    DND_MAPEVENT_NORIP,
    DND_MAPEVENT_EXTRAFAST,
    DND_MAPEVENT_GHOST,
    DND_MAPEVENT_CULLINGMONSTERS,
    DND_MAPEVENT_EXTRASPEED,
...
void RollMapEvents() {
    ...
    if(1) {
#else
    if(random(0, 1.0) <= DND_MERCHANT_SPAWNCHANCE * (100 + HasDungeonUpside(DUN_UPSIDE_MERCHANTCHANCE)) / 100) {
#endif
