...
str WeaponPickupText[MAXWEPS] = {
	 ...
	 "Fires 5 blasts doing 20 damage in a 6 by 4.25 spread. Altfire fires a projectile that deals 150 damage, releasing an acid rain, doing 8-32 damage each. These can't hit \cughosts\c-. Victims explode on death doing 100 damage in 96 unit radius. Inflicts \cqpoison.",
	 ...
	 "Fires silver bolts dealing 300 damage. Altfire increases tension, allowing shots to rip and gain 50% more damage per increase, but instead start from base of 200 damage. Magical or undead enemies hit causes a 150 damage explosion in 128 unit radius.",
	 ...
	 "The torso of a Vulgar. Shoots acidic bones. Alt fire shoots bouncing acid bombs. Can't hit \cughosts\c-. Inflicts \cqpoison. \ceTemporary Weapon.",
	 "A demon heart. Squeeze to damage all enemies  in an area.\cfIgnores shields. \ceTemporary Weapon.",
	 "Gloves of a dark servant. Can shoot pain enforcing lightning bolts doing 60-90 damage. Alt fire shoots a homing explosive lightning ball doing 192 damage on hit and 144 area damage over 9 tics. \ceTemporary Weapon.",
