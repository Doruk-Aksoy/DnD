...
#define SHOP_FIRSTARMOR_PAGE MENU_SHOP_ARMOR1
#define SHOP_LASTARMOR_PAGE MENU_SHOP_ARMOR2
...
#define SHOP_WEAPON52_BEGIN SHOP_WEP_MERC
...
#define SHOP_LASTARMOR_INDEX SHOP_ARMOR_LIGHTNINGCOIL
...
bool IsArmorPage(int page) {
	return page >= SHOP_FIRSTARMOR_PAGE && page <= SHOP_LASTARMOR_PAGE;
}
