...
str InventoryInfo[MAX_COMMON_INVENTORY][3] = {
	...
	{ "OrbofRiches", "Orb of Riches", "\c[Y5]Orb of Riches\nGrants a random resource on use. Can grant experience, credit or budget. Can give \cd5%\c- of your current level's experience, \cd2000\c- or \cd5%\c- of current credits (whichever is greater) and \cd5k\c- respectively." },
