...
#define DND_CHESTKEY_DROPRATE 0.0075 // overall chestkey droprate
...
#define LOOTBOX_DROPWEIGHT 0.2
#define SILVERCHEST_DROPWEIGHT 0.37
#define GOLDCHEST_DROPWEIGHT 0.50

#define DND_LOOTCHEST_DROPRATE 0.05
#define DND_LOOTCHEST_DROPRATE_DUNGEON 0.01
