...
void SetupArmorDropWeights() {
	// Body Armors
	INIT_ITEM_WEIGHTS;
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_GREEN, 16);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_YELLOW, 14);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_BLUE, 10);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_RED, 6);

	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_GUNSLINGER, 6);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_OCCULT, 6);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_DEMO, 6);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_ENERGY, 6);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_ELEMENTAL, 6);

	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_MONOLITH, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_CYBER, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_DUELIST, 8);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_NECRO, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_KNIGHT, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_RAVAGER, 4);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BODY, BODYARMOR_TANGLEDRIBCAGE, 2);
	
	// Boots
	RESET_ITEM_WEIGHTS;
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_SILVER, 15);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_ENGINEER, 15);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_INSULATED, 5);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_PLATED, 10);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_POWER, 5);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_ENERGY, 5);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_TACTICAL, 3);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_FUSION, 12);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_LEATHER, 15);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_SNAKESKIN, 10);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_DRAKESKIN, 10);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_BOOT, BOOTS_WARRIORSABATON, 4);

	// Helms
	RESET_ITEM_WEIGHTS;
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_LICH, 20);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_WARRIOR, 24);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_SYNTHMETAL, 48);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_KNIGHT, 24);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_PREDATOR, 16);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_CRUSADER, 6);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_TACTICAL, 28);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_ROBE, 20);
	SET_ITEM_WEIGHT(DND_DROPPEDITEM_HELM, HELMS_ELDER, 1);
}
