...
#define DND_DAMAGECONVERSION_MASK 0xFF
#define DND_DAMAGECONVERSION_BITS 8
...
enum {
	...
	INV_CORR_MAXPOWER,
	INV_CORR_DAMAGECONVERSION,
	INV_CORR_DAMAGEGAINEDAS,
	...
	INV_EX_CANNOTBEFROZEN,
	INV_EX_CANNOTBEIGNITED,

	// Choir of Ashes
	INV_EX_IGNITE_CHAINS_ONSPREAD,
	INV_EX_IGNITE_INHERITS_DAMAGE,
	INV_EX_CONVERT_PHYSTOFIRE,
	INV_EX_IGNITE_CANNOT_REFRESH,

	// Sightless Vigil
	INV_EX_ACCURACY_NOSPREAD,
	INV_EX_FLATDMG_PERACCURACY,
	INV_EX_SPREAD_PENALTY,

	// Crown of Suffering
	INV_EX_POISON_SHAREDSTACKS,
	INV_EX_POISON_STACKS_NODECAY,
	INV_EX_POISON_CLEARS_ONKILL,
	INV_EX_MAXPOISONSTACK,

	// Faraday Halo
	INV_EX_OVERLOAD_CHAINS_TOSELF,
	INV_EX_OVERLOAD_STORES_DAMAGE,
	INV_EX_OVERLOAD_ONANYELEMENT,
	INV_EX_OVERLOAD_SELFOVERLOAD,

	// Springheel
	INV_EX_DASH_CHARGES,
	INV_EX_DASH_RESETS_ONKILL,
	INV_EX_REDUCED_MOVESPEED,

	// Archangel Beacon
	INV_EX_BUFFS_SHARE_NEARBY,
	INV_EX_SHARED_BUFF_POTENCY,
	INV_EX_BUFFS_SHORTER,

	// Undertow
	INV_EX_DASH_ANCHOR,
	INV_EX_ANCHOR_RESTORES_HP,
	INV_EX_DASH_COOLDOWN_LONG,

	// Emberwake
	INV_EX_IGNITETRAIL,
	INV_EX_TRAIL_SCALES_WITHSPEED,
	INV_EX_BURNS_WHILE_STILL
...
void SetupInventoryAttributeTable() {
	...
	ItemModTable[INV_FLATPHYS_DAMAGE].attrib_high = 5;
	...
	ItemModTable[INV_WEAPONAOE_RADIUS].attrib_low = 1;
	ItemModTable[INV_WEAPONAOE_RADIUS].attrib_high = 10;
	ItemModTable[INV_WEAPONAOE_RADIUS].attrib_level_modifier = 0;
	ItemModTable[INV_WEAPONAOE_RADIUS].tags = INV_ATTR_TAG_ATTACK | INV_ATTR_TAG_EXPLOSIVE;
	ItemModTable[INV_WEAPONAOE_RADIUS].weight = 400;
	ItemModTable[INV_WEAPONAOE_RADIUS].allowed_slots = DND_MODBASE_RADIUSATK;
	SetModTierProfile(INV_WEAPONAOE_RADIUS, DND_TIERSET_OFFENSE_STRONG);
	...
	ItemModTable[INV_ALLAOE_RADIUS].attrib_low = 1;
	ItemModTable[INV_ALLAOE_RADIUS].attrib_high = 8;
	ItemModTable[INV_ALLAOE_RADIUS].attrib_level_modifier = 0;
	ItemModTable[INV_ALLAOE_RADIUS].tags = INV_ATTR_TAG_ATTACK | INV_ATTR_TAG_EXPLOSIVE;
	...
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_low = 5;
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_high = 20;
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_level_modifier = -1;
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_extra_low = DND_DAMAGECONVERSION_BEGIN;
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_extra_high = DND_DAMAGECONVERSION_END - 1; // no magic picking here
	ItemModTable[INV_CORR_DAMAGECONVERSION].attrib_level_extra_modifier = -1;
	ItemModTable[INV_CORR_DAMAGECONVERSION].tags = INV_ATTR_TAG_ATTACK;

	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_low = 1;
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_high = 10;
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_level_modifier = -1;
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_extra_low = DND_DAMAGECONVERSION_BEGIN; // uses same sub-system as damage conversion for indices
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_extra_high = DND_DAMAGECONVERSION_END - 1; // no magic picking here
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].attrib_level_extra_modifier = -1;
	ItemModTable[INV_CORR_DAMAGEGAINEDAS].tags = INV_ATTR_TAG_ATTACK;
