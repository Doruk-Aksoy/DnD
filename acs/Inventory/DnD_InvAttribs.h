...
int MapAttributeToPStat(int mod) {
	switch(mod) {
		...
		case INV_EX_IGNITE_INHERITS_DAMAGE:         return PSTAT_EX_IGNITE_SPREADRETAIN;
		case INV_EX_FLATDMG_PERACCURACY:            return PSTAT_EX_FLATDMG_PERACCURACY;
		case INV_EX_SPREAD_PENALTY:                 return PSTAT_EX_SPREAD_PENALTY;

		// Shares PSTAT_INC_MAXPOISONSTACK with INV_INC_MAXPOISONSTACK on purpose. The two are the
		// same effect and must pool; only the id range differs, which is what picks the colours.
		case INV_EX_MAXPOISONSTACK:                 return PSTAT_INC_MAXPOISONSTACK;
		...
		case INV_EX_MELEEMORE_PERSTAMINA:           return PSTAT_EX_MELEEMORE_PERSTAMINA;
		case INV_EX_STAMINADUMP_AFTERMELEE:         return PSTAT_EX_STAMINADUMP_AFTERMELEE;
		case INV_EX_LESS_STAMINARECOVERY:           return PSTAT_EX_LESS_STAMINARECOVERY;
		case INV_EX_CHANCE_MAXENDURANCE:            return PSTAT_EX_CHANCE_MAXENDURANCE;
		case INV_EX_CHANCE_FREEMELEESTAMINA:        return PSTAT_EX_CHANCE_FREEMELEESTAMINA;
		case INV_EX_MOREDMG_PERMISSINGAMMO:         return PSTAT_EX_MOREDMG_PERMISSINGAMMO;
		case INV_EX_METRONOME_MAGNITUDE:            return PSTAT_METRONOME_MAGNITUDE;
		case INV_EX_METRONOME_WINDOW:               return PSTAT_METRONOME_WINDOW;
		case INV_EX_OFFBEAT_LESSDAMAGE:             return PSTAT_OFFBEAT_LESSDAMAGE;
	}
...
int MapAttributeToPFlag(int mod) {
	switch(mod) {
		...
		case INV_EX_CANNOTBEFROZEN:               	return PFLAG_CANNOTBEFROZEN;
		case INV_EX_CANNOTBEIGNITED:              	return PFLAG_CANNOTBEIGNITED;
		case INV_EX_IGNITE_CHAINS_ONSPREAD:       	return PFLAG_IGNITE_CHAINS;
		case INV_EX_IGNITE_CANNOT_REFRESH:        	return PFLAG_IGNITE_NOREFRESH;
		case INV_EX_ACCURACY_NOSPREAD:            	return PFLAG_ACCURACY_NOSPREAD;
		case INV_EX_POISON_SHAREDSTACKS:          	return PFLAG_POISON_SHAREDSTACKS;
		...
		case INV_EX_NOLOWSTAMINA_DMGLOSS:         	return PFLAG_NOLOWSTAMINA_DMGLOSS;
		case INV_EX_NODEPLETEDSTAMINA_DMGLOSS:    	return PFLAG_NODEPLETEDSTAMINA_DMGLOSS;
		case INV_EX_NOBLEEDEXTRA_MOVING:          	return PFLAG_NOBLEEDEXTRA_MOVING;
		case INV_EX_SWAP_HP_AND_SHIELD:           	return PFLAG_SWAP_HP_SHIELD;
		case INV_EX_METRONOME_BEAT:               	return PFLAG_METRONOME;
	}
