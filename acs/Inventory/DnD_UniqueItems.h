...
void SetupUniqueItems() {
	...
	START_UNIQUE_DATA(UITEM_METRONOME);
	UNIQUE_DATA_ENTRY(50, 1, 1, DND_ITEM_CHARM, DND_CHARM_SMALL, 28, 4);
	UNIQUE_ATTR_ENTRY(INV_EX_METRONOME_BEAT, 1, 1, 0, 0);
	UNIQUE_ATTR_ENTRY(INV_EX_METRONOME_MAGNITUDE, 15, 35, 0, 0);
	UNIQUE_ATTR_ENTRY(INV_EX_METRONOME_WINDOW, 20, 35, 0, 0);
	UNIQUE_ATTR_ENTRY(INV_EX_OFFBEAT_LESSDAMAGE, 25, 50, 0, 0);
	...
	img = IIMG_UDCHRM_7;
	START_UNIQUE_DATA(UITEM_SANGUINECOVENANT);
	UNIQUE_DATA_ENTRY(100, 1, 3, DND_ITEM_CHARM, DND_CHARM_LARGE, 45, 3);
	UNIQUE_ATTR_ENTRY(INV_EX_SWAP_HP_AND_SHIELD, 1, 1, 0, 0);
	UNIQUE_ATTR_ENTRY(INV_SHIELD_INCREASE, 1, 100, 0, 0);
	UNIQUE_ATTR_ENTRY(INV_EX_LESSHEALING, 40, 70, 0, 0);
