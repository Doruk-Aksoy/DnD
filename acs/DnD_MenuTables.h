...
#define INVENTORYBOX_BASEX_TRADEUP 2 * HUDMAX_XF / 3 - 8.4
#define INVENTORYBOX_BASEY_TRADEUP 2 * HUDMAX_YF / 3 - 44.0

#define STASHBOX_BASEX_UP 2 * HUDMAX_XF / 3 + 260.4

#define INVENTORYBOX_BASEX_TRADEDOWN 2 * HUDMAX_XF / 3 - 8.4
#define INVENTORYBOX_BASEY_TRADEDOWN 2 * HUDMAX_YF / 3 + 196.0

#define INVENTORYBOX_BASEX_TRADEMID 2 * HUDMAX_XF / 3 + 324.1
...
int MenuInputData[MAXPLAYERS][2];
