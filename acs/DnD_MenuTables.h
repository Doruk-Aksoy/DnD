...
#define CRAFTING_WEAPON_BOXID (MAX_CRAFTING_NORMAL_BOXES + 1)
#define CRAFTING_INVENTORY_BOXID (CRAFTING_WEAPON_BOXID + 1)
...
struct draw_info WeaponDrawInfo[MAXSHOPWEAPONS] = {
	...
	{ OBJ_WEP | OBJ_RESEARCH,								SHOP_WEP_SICKLE			},
