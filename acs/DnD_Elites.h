...
#define DND_ELITE_MIN_INCREMENT 100 // per DND_MONSTERRARITY_PERLVL levels add 1.0
#define DND_MAGIC_MIN_INCREMENT 200 // per DND_MONSTERRARITY_PERLVL levels add 2.0
...
void SetupEliteModWeights() {
	...
	INSERT_ELITEMODPOOL(DND_ELEMENTAL_RESIST, 0, 250);
	
	INSERT_ELITEMODPOOL(DND_EXPLOSIVE_IMMUNE, 36, 125);
	INSERT_ELITEMODPOOL(DND_BULLET_IMMUNE, 36, 125);
	INSERT_ELITEMODPOOL(DND_ENERGY_IMMUNE, 36, 125);
	INSERT_ELITEMODPOOL(DND_MAGIC_IMMUNE, 36, 125);
	INSERT_ELITEMODPOOL(DND_ELEMENTAL_IMMUNE, 36, 125);
	
	INSERT_ELITEMODPOOL(DND_GHOST, 0, 200);
	...
	INSERT_ELITEMODPOOL(DND_EXTRASTRONG, 0, 250);
	INSERT_ELITEMODPOOL(DND_VITAL, 0, 300);
	INSERT_ELITEMODPOOL(DND_ARMORPEN, 30, 200);
	
	INSERT_ELITEMODPOOL(DND_BLOODLESS, 0, 325);
	INSERT_ELITEMODPOOL(DND_VIOLENTRETALIATION, 40, 180);
	INSERT_ELITEMODPOOL(DND_THIEF, 0, 200);
	INSERT_ELITEMODPOOL(DND_HEXFUSION, 36, 150);
	INSERT_ELITEMODPOOL(DND_REBIRTH, 0, 100);
	INSERT_ELITEMODPOOL(DND_VENOMANCER, 40, 200);
	INSERT_ELITEMODPOOL(DND_FRIGID, 40, 200);
	INSERT_ELITEMODPOOL(DND_SCORCHED, 40, 200);
	INSERT_ELITEMODPOOL(DND_VOLTAIC, 40, 200);
	INSERT_ELITEMODPOOL(DND_REJUVENATING, 30, 175);
	
	INSERT_ELITEMODPOOL(DND_HATRED, 0, 350);
	INSERT_ELITEMODPOOL(DND_SHOCKER, 40, 200);
	INSERT_ELITEMODPOOL(DND_VAMPIRISM, 0, 300);
	INSERT_ELITEMODPOOL(DND_FORTIFIED, 30, 250);
	INSERT_ELITEMODPOOL(DND_SUBORDINATE, 30, 150);
	INSERT_ELITEMODPOOL(DND_REPEL, 36, 125);
	INSERT_ELITEMODPOOL(DND_PHANTASM, 36, 100);
	INSERT_ELITEMODPOOL(DND_CRIPPLE, 40, 185);
	INSERT_ELITEMODPOOL(DND_RUINATION, 40, 185);
	INSERT_ELITEMODPOOL(DND_NUCLEAR, 40, 50);
	INSERT_ELITEMODPOOL(DND_SILENT, 40, 200);
	INSERT_ELITEMODPOOL(DND_OSMIUM, 50, 250);
	INSERT_ELITEMODPOOL(DND_PHASING, 33, 200);
	INSERT_ELITEMODPOOL(DND_OTHERWORLDGRIP, 50, 100);
	INSERT_ELITEMODPOOL(DND_THUNDERSTRUCK, 45, 100);
	INSERT_ELITEMODPOOL(DND_TEMPORALBUBBLE, 50, 175);
	INSERT_ELITEMODPOOL(DND_BLACKOUT, 40, 175);
	INSERT_ELITEMODPOOL(DND_ENSHROUDED, 30, 150);

	INSERT_ELITEMODPOOL(DND_TOXICBLOOD, 0, 400);
	INSERT_ELITEMODPOOL(DND_FROSTBLOOD, 0, 400);
	INSERT_ELITEMODPOOL(DND_MOLTENBLOOD, 0, 400);
	INSERT_ELITEMODPOOL(DND_INSULATED, 0, 400);

	INSERT_ELITEMODPOOL(DND_PENETRATOR, 40, 200);
	INSERT_ELITEMODPOOL(DND_FASTPROJ, 30, 325);
