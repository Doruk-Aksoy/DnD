...
str Weapons[MAXWEPS][MAX_WEAPON_STRINGS] = { 		     
	 ...
	 { " Akimbo Pistols ",					"Akimbo Longslides",		"2",		"Clip",				" ",							"GotAkimbo",				"AKIMICO",		"WEPICO10"	},
	 ...
	 { "Upgraded Super Shotgun",			"Heavy Super Shotgun",		"3",		"Shell",			" ",							"GotSSG",					"SSGPA0",		"WEPICO25"	},
	 ...
	 { "Upgraded Machine Gun",			    "Heavy Machine Gun",		"4",		"Clip",				"MGClip2",				    	"GotMG",					"WSG2ICO", 		"WEPICO34"	},
	 ...
	 { "ResMG1",							"Templar Machine Gun",		"4",		"Clip",				"MGClip4",				    	"GotMG",					"RW03X0",		"WEPICO37"	},
	 ...
	 { "Rocket Launcher",					"Rocket Launcher",			"5",		"RocketAmmo",		" ",							"GotRL",					"LAUNICO",		"WEPICO44"	},
	 { "Upgraded Rocket Launcher",		    "Torpedo Launcher",			"5",		"RocketAmmo",		" ",							"GotRL",					"WPPKG0",		"WEPICO45"	},
	 { "Upgraded Rocket Launcher2",		    "Mercury Launcher",			"5",		"RocketAmmo",		" ",							"GotRL",					"MERCICO",		"WEPICO46"	},
	 ...
	 { "Heavy Missile Launcher",			"Heavy Missile Launcher",	"5",		"MISAmmo",			" ",							"GotHML",					"WMLNA0",		"WEPICO53"	},
	 
	 { "Plasma Rifle",						"Plasma Rifle",				"6",		"Cell",				" ",							"GotPL",					"NRAIE0",		"WEPICO54"	},
	 { "Upgraded Plasma Rifle",				"Nuclear Plasma Rifle",		"6",		"Cell",				"PlasmaOverheat",		        "GotPL",					"QNPLX0",		"WEPICO55"	},
	 ...
	 { "Sawedoff",							"Sawed-off Super Shotgun",	"9",		"SawedoffShell",	"SawedoffCounter",		        "GotSawedoff",				"SAWNICO",		"WEPICO76"	},
	 { "Soul Render",						"Soul Render",				"9",		"BladeHits",		"BladeCharge",				    "GotSoul",					"SWOICO",		"WEPICO77"	},
	 { "SMG",								"Submachine Gun",			"9",		"SMGAmmo",			" ",							"GotSMG",					"SMGICO",  		"WEPICO78"	},
	 ...
	 { "Nailgun2",                          "Heavy Nail Gun",			"9",        "BigNail",          " ",                            "GotNailgun2",              "NLCGF0",       "WEPICO85"	},
