...
7z u -t7z dnd.pk7 ./dnd/* -mx=9 -ms=off
7z d dnd.pk7 TEXTURES -x!TEXTURES/
7z rn dnd.pk7 TEXTURES_ TEXTURES
7z u -t7z dnd_monsters.pk7 ./monsters/* -mx=9 -ms=off
7z u -t7z dnd_onlyammo.pk7 ./onlyammo/* -mx=9 -ms=off
